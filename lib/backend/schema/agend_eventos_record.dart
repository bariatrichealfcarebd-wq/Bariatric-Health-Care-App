...
class AgendEventosRecord extends FirestoreRecord {
  ...
  // "uid_Nutricionista" field.
  String? _uidNutricionista;
  String get uidNutricionista => _uidNutricionista ?? '';
  bool hasUidNutricionista() => _uidNutricionista != null;
  ...
  void _initializeFields() {
    ...
    _uidNutricionista = snapshotData['uid_Nutricionista'] as String?;
...
Map<String, dynamic> createAgendEventosRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'uid_Nutricionista': uidNutricionista,
      'descricao': descricao,
    }.withoutNulls,
  );
...
class AgendEventosRecordDocumentEquality
  ...
  bool equals(AgendEventosRecord? e1, AgendEventosRecord? e2) {
    return e1?.data == e2?.data &&
        ...
        e1?.uidNutricionista == e2?.uidNutricionista &&
        e1?.descricao == e2?.descricao;
  }

  @override
  int hash(AgendEventosRecord? e) => const ListEquality().hash(
      [e?.data, e?.hora, e?.uidPaaciente, e?.uidNutricionista, e?.descricao]);
