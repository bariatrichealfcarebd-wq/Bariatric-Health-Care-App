...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PrescricoesPageWidget.routeName,
          path: PrescricoesPageWidget.routePath,
          builder: (context, params) => PrescricoesPageWidget(
            scroll: params.getParam(
              'scroll',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          name: QuestionsPageWidget.routeName,
          path: QuestionsPageWidget.routePath,
          builder: (context, params) => QuestionsPageWidget(),
        ),
        FFRoute(
          name: AlimentacaoPageWidget.routeName,
          path: AlimentacaoPageWidget.routePath,
        ...
        FFRoute(
          ...
          path: SuplementacaoCutaneaWidget.routePath,
          builder: (context, params) => SuplementacaoCutaneaWidget(),
        ),
        FFRoute(
          name: OutraSuplementacoesWidget.routeName,
          path: OutraSuplementacoesWidget.routePath,
          builder: (context, params) => OutraSuplementacoesWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: RecuperaPt1Widget.routePath,
          builder: (context, params) => RecuperaPt1Widget(),
        ),
        FFRoute(
          name: RecuperarPt2Widget.routeName,
          path: RecuperarPt2Widget.routePath,
          builder: (context, params) => RecuperarPt2Widget(),
        ),
        FFRoute(
          name: CentraldeAjudaWidget.routeName,
          path: CentraldeAjudaWidget.routePath,
          builder: (context, params) => CentraldeAjudaWidget(),
        ),
        FFRoute(
          name: SeguranacaPrivacidadeWidget.routeName,
          path: SeguranacaPrivacidadeWidget.routePath,
          builder: (context, params) => SeguranacaPrivacidadeWidget(),
        ),
        FFRoute(
          name: PaginadoNutricionistaWidget.routeName,
          path: PaginadoNutricionistaWidget.routePath,
          builder: (context, params) => PaginadoNutricionistaWidget(),
        ),
        FFRoute(
          name: QuestionarioWidget.routeName,
          path: QuestionarioWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => HistoricoSupWidget(
            supDiariaEditar: params.getParam<DocumentReference>(
              'supDiariaEditar',
              ParamType.DocumentReference,
              isList: true,
              collectionNamePath: ['Suplementacaodiaria'],
            ),
            supCutaneaEditar: params.getParam<DocumentReference>(
              'supCutaneaEditar',
              ParamType.DocumentReference,
              isList: true,
              collectionNamePath: ['suplementacao'],
            ),
            supOutrosEditar: params.getParam<DocumentReference>(
              'supOutrosEditar',
              ParamType.DocumentReference,
              isList: true,
              collectionNamePath: ['outrasSuplementacao'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AssistenteGeminiWidget.routeName,
          path: AssistenteGeminiWidget.routePath,
          builder: (context, params) => AssistenteGeminiWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/logoBariatricNome.png',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
