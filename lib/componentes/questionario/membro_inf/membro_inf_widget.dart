...
import 'membro_inf_model.dart';
export 'membro_inf_model.dart';

class MembroInfWidget extends StatefulWidget {
  const MembroInfWidget({super.key});

  @override
  State<MembroInfWidget> createState() => _MembroInfWidgetState();
}

class _MembroInfWidgetState extends State<MembroInfWidget>
    with TickerProviderStateMixin {
  late MembroInfModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembroInfModel());
                                ...
                                child: StreamBuilder<List<SintomasRecord>>(
                                  stream: querySintomasRecord(
                                    queryBuilder: (sintomasRecord) =>
                                      ...
                                      'categoria',
                                      arrayContains: 'membros inferiores',
                                    ),
                                  ),
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return wrapWithModel(
                                          ...
                                          child: ItemSintomaWidget(
                                            key: Key(
                                              'Keyfyg_${listViewSintomasRecord.reference.id}',
                                            ),
