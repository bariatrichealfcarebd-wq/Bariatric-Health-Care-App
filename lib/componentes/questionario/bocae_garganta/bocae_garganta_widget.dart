...
import 'bocae_garganta_model.dart';
export 'bocae_garganta_model.dart';

class BocaeGargantaWidget extends StatefulWidget {
  const BocaeGargantaWidget({super.key});

  @override
  State<BocaeGargantaWidget> createState() => _BocaeGargantaWidgetState();
}

class _BocaeGargantaWidgetState extends State<BocaeGargantaWidget>
    with TickerProviderStateMixin {
  late BocaeGargantaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BocaeGargantaModel());
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return wrapWithModel(
                                        ...
                                        child: ItemSintomaWidget(
                                          key: Key(
                                            'Keygp5_${listViewSintomasRecord.reference.id}',
                                          ),
