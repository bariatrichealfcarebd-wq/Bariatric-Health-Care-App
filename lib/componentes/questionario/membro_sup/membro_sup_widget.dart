...
import 'membro_sup_model.dart';
export 'membro_sup_model.dart';

class MembroSupWidget extends StatefulWidget {
  const MembroSupWidget({super.key});

  @override
  State<MembroSupWidget> createState() => _MembroSupWidgetState();
}

class _MembroSupWidgetState extends State<MembroSupWidget>
    with TickerProviderStateMixin {
  late MembroSupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembroSupModel());
                              ...
                              child: StreamBuilder<List<SintomasRecord>>(
                                stream: querySintomasRecord(
                                  queryBuilder: (sintomasRecord) =>
                                    ...
                                    'categoria',
                                    arrayContains: 'membros superiores',
                                  ),
                                ),
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return wrapWithModel(
                                        ...
                                        child: ItemSintomaWidget(
                                          key: Key(
                                            'Keybmw_${listViewSintomasRecord.reference.id}',
                                          ),
