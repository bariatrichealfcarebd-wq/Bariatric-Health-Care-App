...
import 'alteracaodfuncoes_model.dart';
export 'alteracaodfuncoes_model.dart';

class AlteracaodfuncoesWidget extends StatefulWidget {
  const AlteracaodfuncoesWidget({super.key});

  @override
  State<AlteracaodfuncoesWidget> createState() =>
      _AlteracaodfuncoesWidgetState();
}

class _AlteracaodfuncoesWidgetState extends State<AlteracaodfuncoesWidget>
    with TickerProviderStateMixin {
  late AlteracaodfuncoesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlteracaodfuncoesModel());
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return wrapWithModel(
                                        ...
                                        child: ItemSintomaWidget(
                                          key: Key(
                                            'Keywtr_${listViewSintomasRecord.reference.id}',
                                          ),
