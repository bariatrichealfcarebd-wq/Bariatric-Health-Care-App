...
import 'pele_model.dart';
export 'pele_model.dart';

class PeleWidget extends StatefulWidget {
  const PeleWidget({super.key});

  @override
  State<PeleWidget> createState() => _PeleWidgetState();
}

class _PeleWidgetState extends State<PeleWidget> with TickerProviderStateMixin {
  late PeleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PeleModel());
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return wrapWithModel(
                                          ...
                                          child: ItemSintomaWidget(
                                            key: Key(
                                              'Keyj34_${listViewSintomasRecord.reference.id}',
                                            ),
