                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.ficheiroCarregado == null ||
                              (_model.ficheiroCarregado?.bytes?.isEmpty ??
                                  true))
                            InkWell(
                              splashColor: Colors.transparent,
                              focusColor: Colors.transparent,
                              ...
                              onTap: () async {
                                ...
                                if (selectedFiles != null) {
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataLd1 = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadDataLd1 =
                                        false;
                                  }
                                    ...
                                    if (_model.pacienteData?.reference !=
                                        null) {
                                      {
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadDataTp5 =
                                              false;
                                        }
                                        if (selectedUploadedFiles.length ==
                                                selectedFiles.length &&
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: Text(
                                                'Nova recomendação alimentar criada'),
                                            actions: [
                                              TextButton(
                                      ...
                                      try {
                                        final result = await FirebaseFunctions
                                          ...
                                          "titulo":
                                              'nova notificação em alimentação',
                                          "mensagem":
