                                    ...
                                    children: [
                                      AuthUserStreamWidget(
                                        builder: (context) =>
                                            FutureBuilder<int>(
                                          future:
                                              queryLigacaoSintomaRecordCount(
                                            queryBuilder:
                                                (ligacaoSintomaRecord) =>
                            ...
                            onPressed: () async {
                              ...
                              if ((_model.popup == true) &&
                                ...
                                await actions.gerarPDFparaStorage(
                                  ...
                                  currentUserUid,
                                  valueOrDefault(
                                      currentUserDocument?.codigoPaciente, ''),
                                );
                                _model.gerarGrafico =
                                ...
                                for (int loop1Index = 0;
                                    loop1Index <
                                        _model.documentoParaApagar!.length;
                                    loop1Index++) {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: Text(
                                          'Os itens selecionado foram enviados '),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                ...
                                try {
                                  final result = await FirebaseFunctions
                                      ...
                                      .call({
                                    "destinatarioUid": valueOrDefault(
                                        currentUserDocument?.uidNutri, ''),
                                    "titulo": 'Notificação',
                                    "mensagem":
                                        'Umm questionario foi respondido',
                                    "tipo": 'QUESTIONARIO_ENVIADO',
                                  });
                                  _model.cloudFunctionndj =
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text(
                                          'Verefique as demais categorias '),
                                      content: Text(
