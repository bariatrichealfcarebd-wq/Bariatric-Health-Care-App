...
class _CadastroWidgetState extends State<CadastroWidget> {
  ...
  void initState() {
    ...
    _model.senhaConfirmTextController ??= TextEditingController();
    _model.senhaConfirmFocusNode ??= FocusNode();
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            12.0, 8.0, 0.0, 12.0),
                        child: Text(
                          'Cadastre o usuário com as seguintes infomações',
                          textAlign: TextAlign.start,
                          style:
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            controller: _model.cPFCadastroTextController,
                            ...
                            validator: _model.cPFCadastroTextControllerValidator
                                .asValidator(context),
                          ),
                          TextFormField(
                            ...
                            onChanged: (_) => EasyDebounce.debounce(
                              ...
                              () async {
                                if ((_model.emailCadastroTextController
                                                .text !=
                                            '') &&
                                    ((String email) {
                                      return RegExp(
                            ...
                            onChanged: (_) => EasyDebounce.debounce(
                              ...
                              () async {
                                if ((_model.senhaTextController.text !=
                                  ...
                                  _model.validarSenha = true;
                                  safeSetState(() {});
                                } else {
                                  _model.validarSenha = false;
                                  safeSetState(() {});
                                }
                              },
                            ),
                          ...
                          TextFormField(
                            controller: _model.senhaConfirmTextController,
                            focusNode: _model.senhaConfirmFocusNode,
                            autofocus: false,
                            obscureText: !_model.senhaConfirmVisibility,
                            decoration: InputDecoration(
                            ...
                            validator: _model
                                .senhaConfirmTextControllerValidator
                                .asValidator(context),
                          ),
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: (((String email) {
                          ...
                          : () async {
                              if (functions.validarCPF(
                                ...
                                if (_model.senhaTextController.text !=
                                    _model.senhaConfirmTextController.text) {
                      ...
                      options: FFButtonOptions(
                        ...
                        disabledColor: Color(0x7157636C),
                      ),
                    ),
                  ),
                ),
