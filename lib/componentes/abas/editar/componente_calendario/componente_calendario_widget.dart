...
class ComponenteCalendarioWidget extends StatefulWidget {
  const ComponenteCalendarioWidget({
    super.key,
    required this.agendaNutri,
  });

  final DocumentReference? agendaNutri;
...
class _ComponenteCalendarioWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.agendadados =
          await AgendEventosRecord.getDocumentOnce(widget.agendaNutri!);
      _model.dataCarregada = _model.agendadados?.data;
      _model.horaCarregada = _model.agendadados?.hora;
      safeSetState(() {});
      safeSetState(() {
        _model.dataTextController?.text = dateTimeFormat(
          "d/M",
          _model.agendadados!.data!,
          locale: FFLocalizations.of(context).languageCode,
        );
      });
      safeSetState(() {
        _model.horaTextController?.text = dateTimeFormat(
          "jm",
          _model.agendadados!.hora!,
          locale: FFLocalizations.of(context).languageCode,
        );
      });
      safeSetState(() {
        _model.descrTextController?.text = _model.agendadados!.descricao;
      });
    });
    ...
    _model.descrTextController ??= TextEditingController();
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                'Edite a nova data de agendamento do paciente: ',
          ...
          Column(
            ...
            children: [
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        8.0, 20.0, 0.0, 0.0),
                                    child: Text(
                                      'Selecione o novo horario da consulta:',
                                      style: FlutterFlowTheme.of(context)
                                          .displayMedium
                                          .override(
                                            font: GoogleFonts.interTight(
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                ...
                                                _model.horaCarregada = null;
                                                safeSetState(() {});
                                                _model.horaCarregada =
                                                    _model.datePicked2;
                                                safeSetState(() {});
                                                safeSetState(() {
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      width: 800.0,
                                      child: TextFormField(
                                        controller: _model.descrTextController,
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await widget.agendaNutri!
                        .update(createAgendEventosRecordData(
                      data: _model.datePicked1,
                      hora: _model.datePicked2,
                      descricao: _model.descrTextController.text,
                    ));
                    await showDialog(
                      context: context,
