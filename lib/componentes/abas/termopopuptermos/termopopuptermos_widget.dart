...
import 'termopopuptermos_model.dart';
export 'termopopuptermos_model.dart';

class TermopopuptermosWidget extends StatefulWidget {
  const TermopopuptermosWidget({super.key});

  @override
  State<TermopopuptermosWidget> createState() => _TermopopuptermosWidgetState();
}

class _TermopopuptermosWidgetState extends State<TermopopuptermosWidget> {
  late TermopopuptermosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TermopopuptermosModel());
