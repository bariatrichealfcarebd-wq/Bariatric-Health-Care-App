...
import 'termo_perm_pop_up_model.dart';
export 'termo_perm_pop_up_model.dart';

class TermoPermPopUpWidget extends StatefulWidget {
  const TermoPermPopUpWidget({
    super.key,
    bool? concordaParam,
  }) : this.concordaParam = concordaParam ?? false;

  final bool concordaParam;

  @override
  State<TermoPermPopUpWidget> createState() => _TermoPermPopUpWidgetState();
}

class _TermoPermPopUpWidgetState extends State<TermoPermPopUpWidget> {
  late TermoPermPopUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TermoPermPopUpModel());
