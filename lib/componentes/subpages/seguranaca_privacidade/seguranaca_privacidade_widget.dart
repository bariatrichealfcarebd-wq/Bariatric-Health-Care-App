...
import '/terminar/termo_perm_pop_up/termo_perm_pop_up_widget.dart';
import '/index.dart';
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primary,
                                validator: _model
                                    .senhaNova2TextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            Padding(
                                        ...
                                        builder: (dialogContext) {
                                          return Dialog(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: TermoPermPopUpWidget(),
                                            ),
                                          );
                                        },
                                      );

                                      if (FFAppState().concordaParam == true) {
