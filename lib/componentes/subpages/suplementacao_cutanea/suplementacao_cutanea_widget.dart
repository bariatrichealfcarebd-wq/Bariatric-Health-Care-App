...
class _SuplementacaoCutaneaWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (valueOrDefault<bool>(currentUserDocument?.isADM, false) == true) {
        ...
        await querySuplementacaoRecordOnce(
          queryBuilder: (suplementacaoRecord) => suplementacaoRecord.where(
            'id_User',
    ...
    _model.doseRecomendadaTextController ??= TextEditingController(text: '\n');
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    FFAppState().DataSelecionada = FFAppState()
                                        .DataSelecionada
                                        .toList()
                                        .cast<DateTime>();
                                    safeSetState(() {});
