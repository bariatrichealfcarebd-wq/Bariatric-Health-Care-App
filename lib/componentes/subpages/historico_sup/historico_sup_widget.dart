...
import '/componentes/abas/editar/editar_outros_suplementos/editar_outros_suplementos_widget.dart';
import '/componentes/abas/editar/editar_suplementao_diaria/editar_suplementao_diaria_widget.dart';
import '/componentes/abas/editar/editar_suplemento_cutaneo/editar_suplemento_cutaneo_widget.dart';
...
class HistoricoSupWidget extends StatefulWidget {
  const HistoricoSupWidget({
    super.key,
    this.supDiariaEditar,
    this.supCutaneaEditar,
    this.supOutrosEditar,
  });

  /// puxar suplementação diaria
  final List<DocumentReference>? supDiariaEditar;

  /// puxar suplementação cutanea
  final List<DocumentReference>? supCutaneaEditar;

  /// puxar suplementação Outros
  final List<DocumentReference>? supOutrosEditar;
                              ...
                              children: [
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            rowSuplementacaodiariaRecord.tipoSuplementacao,
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: FlutterFlowIconButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    await launchURL(rowSuplementacaodiariaRecord.anexo);
                                                                                  },
                                                                                ),
                                                                              ),
                                                                              if (valueOrDefault<bool>(currentUserDocument?.isADM, false) == true)
                                                                                          ...
                                                                                          builder: (context) {
                                                                                            return GestureDetector(
                                                                                              ...
                                                                                              child: Padding(
                                                                                                ...
                                                                                                child: Container(
                                                                                                  height: 715.0,
                                                                                                  child: EditarSuplementaoDiariaWidget(
                                                                                                    suplementoDiarioEditar: rowSuplementacaodiariaRecord.reference,
                                                                                                  ),
                                                                                                ),
                                                                                              ),
                                                                                            );
                                ...
                                KeepAliveWidgetWrapper(
                                  builder: (context) => Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      if ((_model.pacienteDat?.reference !=
                                              null) ||
                                          ((valueOrDefault<bool>(
                                                      currentUserDocument
                                                          ?.isADM,
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      ...
                                                                      child: StreamBuilder<
                                                                          SuplementacaoRecord>(
                                                                        stream:
                                                                            SuplementacaoRecord.getDocument(cutaneaListItemItem),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          // Customize what your widget looks like when it's loading.
                                                                          ...
                                                                          return Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(150.0, 0.0, 3.0, 0.0),
                                                                                child: FlutterFlowIconButton(
                                                                                  borderRadius: 8.0,
                                                                                  fillColor: Color(0xFF78C3BA),
                                                                                  icon: Icon(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    await launchURL(rowSuplementacaoRecord.anexo);
                                                                                  },
                                                                                ),
                                                                              ),
                                                                              if (valueOrDefault<bool>(currentUserDocument?.isADM, false) == true)
                                                                                  ...
                                                                                  child: InkWell(
                                                                                    ...
                                                                                    onTap: () async {
                                                                                      var confirmDialogResponse = await showDialog<bool>(
                                                                                          ...
                                                                                          false;
                                                                                      if (confirmDialogResponse) {
                                                                                        await cutaneaListItemItem.delete();
                                                                                      }
                                                                                    },
                                                                                    child: Icon(
                                                                                      Icons.delete_rounded,
                                                                                        ...
                                                                                        builder: (context) {
                                                                                          return GestureDetector(
                                                                                            ...
                                                                                            child: Padding(
                                                                                              ...
                                                                                              child: Container(
                                                                                                height: 715.0,
                                                                                                child: EditarSuplementoCutaneoWidget(
                                                                                                  suplementacaoCutanea: rowSuplementacaoRecord.reference,
                                                                                                ),
                                                                                              ),
                                                                                            ),
                                                                                          );
                                                                        ...
                                                                        children: [
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  rowOutrasSuplementacaoRecord.nome,
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        font: GoogleFonts.inter(
                                                                                          fontWeight: FontWeight.w500,
                                                                                          fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                                ...
                                                                                Text(
                                                                                  dateTimeFormat(
                                                                                    "d/M/y",
                                                                                    rowOutrasSuplementacaoRecord.dataMedic!,
                                                                                    locale: FFLocalizations.of(context).languageCode,
                                                                                  ),
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: FlutterFlowIconButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    await launchURL(rowOutrasSuplementacaoRecord.anexo);
                                                                                  },
                                                                                ),
                                                                              ),
                                                                              if (valueOrDefault<bool>(currentUserDocument?.isADM, false) == true)
                                                                                        ...
                                                                                        builder: (context) {
                                                                                          return GestureDetector(
                                                                                            ...
                                                                                            child: Padding(
                                                                                              ...
                                                                                              child: Container(
                                                                                                height: 715.0,
                                                                                                child: EditarOutrosSuplementosWidget(
                                                                                                  outrosSuplementos: rowOutrasSuplementacaoRecord.reference,
                                                                                                ),
                                                                                              ),
                                                                                            ),
                                                                                          );
