...
import 'recuperar_pt2_model.dart';
export 'recuperar_pt2_model.dart';

class RecuperarPt2Widget extends StatefulWidget {
  const RecuperarPt2Widget({super.key});

  static String routeName = 'RecuperarPt2';
  static String routePath = '/recuperarPt2';

  @override
  State<RecuperarPt2Widget> createState() => _RecuperarPt2WidgetState();
}

class _RecuperarPt2WidgetState extends State<RecuperarPt2Widget> {
  late RecuperarPt2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecuperarPt2Model());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: FFAppState().isOffline == false
            ? AppBar(
                backgroundColor: Color(0xFF88B2AD),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                'Agora você pode criar sua nova senha',
                                                style:
